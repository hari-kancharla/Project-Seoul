...
public:
  ShellController(ShellWindowKey window, Profile *profile,
                  OrganizationModel *model,
                  ProjectionService *projection_service,
                  LiveWindowStateProvider *live_state,
                  CommandExecutor *executor, LifecycleCoordinator *lifecycle,
  ...
  void
  SetFocusWindowCallback(base::RepeatingCallback<bool(LiveWindowKey)> callback);
  ...
  void
  OnWorkspaceSwitchPhaseChanged(WorkspaceSwitchPhase phase,
